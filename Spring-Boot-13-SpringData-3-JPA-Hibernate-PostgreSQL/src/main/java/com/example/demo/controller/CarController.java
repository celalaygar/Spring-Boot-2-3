...
public class CarController {
	...
	public String insertCar() {
		Car c1=new Car("Opel Tigra",1997);
		Car c2=new Car("Land Rover",2012);
		Car c3=new Car("Honda Typer TX",2011);
		Car c4=new Car("Ford Mondeo X",2003);
		Car c5=new Car("Opel Corsa SLX",2011);
		c1.setCar_details(new CarDetails("Opel Almanya Üretimi"));
		c2.setCar_details(new CarDetails("Land Rover Amerika Üretimi"));
		c3.setCar_details(new CarDetails("Honda Japonya Üretimi"));
		c4.setCar_details(new CarDetails("Ford Amerika Üretimi"));
		c5.setCar_details(new CarDetails("Opel Almmanya Üretimi"));
